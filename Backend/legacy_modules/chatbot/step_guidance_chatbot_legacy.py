...
class StepContextAgent:
    ...
    def set_task_context(self, task_name: str, total_steps: int, steps_data: Optional[Dict[int, Dict[str, Any]]] = None,
                         tools_data: Optional[Dict[str, Dict[str, Any]]] = None, problem_summary: str = ""):
...
class StepInstructionAgent:
    ...
    def get_step_guidance(self, step_data: Dict[str, Any], user_message: str = "",
...
class SafetyValidationAgent:
    ...
    def validate_step_safety(self, step_context: Dict[str, Any], user_message: str = "") -> Dict[str, Any]:
        ...
        # Check API key presence
        if not self.api_key:
            return {"safety_level": "unknown", "warnings": ["Missing API key"], "required_equipment": [],
                    "precautions": [], "emergency_info": "Cannot assess safety without API access"}
...
class ToolGuidanceAgent:
    ...
    def get_tool_guidance(self, tool_name: str, current_step: int, user_message: str = "",
                          context: Dict[str, Any] = None) -> str:
...
class TaskExecutionAgent:
    ...
    def start_task(self, task_name: str, total_steps: int, steps_data: Optional[Dict[int, Dict[str, Any]]] = None,
                   tools_data: Optional[Dict[str, Dict[str, Any]]] = None, problem_summary: str = "") -> str:
...
"""
    ...
    def _generate_guidance_response(self, user_message: str, context: Dict[str, Any]) -> str:
        ...
        if intent == "step_instructions":
            ...
            if tool_name:
                tool_guidance = self.tool_agent.get_tool_guidance(tool_name, context["current_step"], user_message,
                                                                  context)
...
"""
    ...
    def _detect_intent_with_llm(self, user_message: str, context: Dict[str, Any]) -> str:
        ...
        current_step_data = context.get('current_step_data', {})
        step_title = current_step_data.get('title',
                                           f'Step {context.get("current_step", 1)}') if current_step_data else f'Step {context.get("current_step", 1)}'
    ...
    def _detect_intent_fallback(self, user_message: str) -> str:
        ...
        safety_keywords = ["safe", "safety", "dangerous", "risk", "warning", "precaution", "protection", "gear",
                           "equipment"]
...
"""
    ...
    def _provide_general_help(self, context: Dict[str, Any]) -> str:
        ...
        current_step_data = context.get('current_step_data', {})
        step_title = current_step_data.get('title',
                                           f'Step {context["current_step"]}') if current_step_data else f'Step {context["current_step"]}'
...
class StepGuidanceChatbot:
    ...
    def start_new_task(self, task_name: str, total_steps: int, steps_data: Optional[Dict[int, Dict[str, Any]]] = None,
                       tools_data: Optional[Dict[str, Dict[str, Any]]] = None, problem_summary: str = "") -> str:
