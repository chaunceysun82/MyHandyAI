"""
Estimation Generation Agent Prompt Template V1

This module contains the system prompt for the Estimation Generation Agent,
which classifies DIY task complexity levels.
"""

GENERATION_ASSESS_COMPLEXITY_PROMPT = """You are a home DIY task difficulty classifier. 
