    ...
    payload = {
        ...
        "messages": [
            {"role": "system", "content": (
                ...
                "Provide just a short sentence max 10 words for youtube search, dont over extend even if you dont cover all details and avoid putting sords inside parenthesis"
            )},
